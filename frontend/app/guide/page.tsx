...
export default function GuidePage() {
  ...
  const roleContext: Record<string, string> = {
    ...
    trustee: "As a trustee or court officer, you can verify any attestation for free and download a court-ready proof JSON artifact.",
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-900 border border-teal-500/40 rounded-xl p-5">
              ...
              <p className="text-sm text-gray-400">
                Someone gave you a filing ID, wallet, and salt. You want to confirm the lien is active on the blockchain.
              </p>
            ...
            <div className="bg-gray-900 border border-blue-500/40 rounded-xl p-5">
              ...
              <p className="text-sm text-gray-400">
                You are a lender or fiduciary who wants to create a new on-chain attestation linked to a UCC-1 filing.
              </p>
              <p className="text-xs text-blue-400 mt-3 font-semibold">Follow Steps 1-6 below</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              {[
                { name: "Filing ID", example: "NY-202607-123456789", desc: "The UCC-1 filing number from the Secretary of State. For tests you can use any unique identifier.", color: "border-teal-500", lc: "text-teal-400" },
                { name: "Wallet Address", example: "0x5DC1...7778", desc: "The secured party wallet - the lender or custodian recording the security interest. Must start with 0x.", color: "border-blue-500", lc: "text-blue-400" },
                { name: "Salt", example: "b02e9855...", desc: "A random 64-character string preventing brute-force guessing. Generated automatically. MUST be saved - you cannot verify without it.", color: "border-purple-500", lc: "text-purple-400" },
              ].map((input) => (
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3">
              <p className="text-xs text-yellow-400">
                <span className="font-bold">Critical:</span> The salt is NOT on the public UCC-1. It is published in the off-chain metadata JSON. Always save your salt in at least two secure locations.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
            ...
            <ol className="space-y-3 mb-4">
              {[
                ...
                "Enter the Filing ID from the public UCC-1 collateral description",
                ...
                "Read the result: Active means the lien is in force. Revoked means it was terminated by the original attester.",
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
            ...
            <ol className="space-y-3 mb-4">
              {[
                ...
                "Enter your UCC-1 Filing ID - use your actual filing number from the Secretary of State",
                "Enter your secured party wallet address in 0x... format",
                "Click Generate Salt - this creates a cryptographically random 64-character string. Do not skip this.",
                "SAVE THE SALT NOW - copy it to a password manager or secure note. You cannot verify without it.",
                "Click Generate Commitment Hash - a 0x... hash appears",
                "Copy and save the hash - this is what gets written to the blockchain",
              ].map((step, i) => (
                <li key={i} className="flex gap-3 text-sm text-gray-300">
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
            ...
            <div className="bg-gray-800 rounded-lg p-4 mb-4">
              ...
              <ul className="text-xs text-gray-300 space-y-1">
                ...
                <li>Your commitment hash from Step 3</li>
              </ul>
            </div>
            <ol className="space-y-3 mb-4">
              {[
                ...
                "Confirm MetaMask is set to Polygon Mainnet - NOT a testnet",
                "Find the function called 1. attest in the list of functions",
                "In the commitmentHash field: paste your full 0x... hash from Step 3",
                ...
                "Save the Transaction Hash, Block Number, and Timestamp shown on PolygonScan",
              ].map((step, i) => (
                <li key={i} className="flex gap-3 text-sm text-gray-300">
                  <span className="text-blue-400 font-bold flex-shrink-0">{i + 1}.</span>
                  {step}
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3">
                ...
                <p className="text-xs text-gray-300">
                  The wallet you use to call attest() becomes the recorded secured party. Use the SAME wallet address you entered in Step 3. Only this wallet can later revoke the attestation.
                </p>
              </div>
            </div>
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Include the commitment hash in your collateral description</p>
              </div>
            </div>
            <p className="text-sm text-gray-300 mb-4">
              File your UCC-1 at the NY Department of State online portal. In the collateral description field include a reference to your on-chain attestation using this template:
            </p>
...
commitment hash [YOUR_HASH], block [BLOCK_NUMBER].
Metadata at [YOUR_METADATA_URL].`}
            </div>
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-yellow-400">
                <span className="font-bold">Legal note:</span> This is draft template language only. Not legal advice. Have a secured-transactions attorney review before use in any real transaction.
              </p>
            </div>
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Make the salt publicly available so anyone can verify</p>
              </div>
            </div>
            <p className="text-sm text-gray-300 mb-4">
  ...
  "filing_state": 1
            ...
            <ol className="space-y-2 mb-4">
              {[
                ...
                "Commit it to a public GitHub repository under a /metadata folder",
                "The raw GitHub URL becomes your metadata URL - include it in your UCC-1",
                "Go to verify.ucc-chain.org and enter your three inputs to confirm Active status",
                "Download the Proof JSON - this is your court-ready verification artifact",
              ].map((step, i) => (
                <li key={i} className="flex gap-3 text-sm text-gray-300">
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: "How much does it cost to attest?", a: "Approximately $0.001 to $0.003 in Polygon gas fees. Less than a fraction of a cent." },
                { q: "What states does this work in?", a: "Currently New York only for the June 3, 2026 launch. Multi-state expansion planned for Phase 4 (2028+) pending state-specific legal review." },
